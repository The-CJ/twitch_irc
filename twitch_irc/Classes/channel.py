...
class Channel(object):
	...
	def __init__(self, raw:str, emergency:bool=False, Msg:Message=None):
		...
		self._users:Dict[str, User] = UserStore()
	...
	def buildFromEvent(self, raw:str) -> None:
		...
		@broadcaster-lang=;emote-only=0;followers-only=-1;r9k=0;rituals=0;room-id=94638902;slow=0;subs-only=0 :tmi.twitch.tv ROOMSTATE #phaazebot
		"""
	...
	def followers_only(self) -> int:
		return bool(self._followers_only or 0)
