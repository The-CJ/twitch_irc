...
class Raid(UserNoticeStructure):
	"""
	Raiding means, a another channel just gone offline and brings the viewers from there, to this channel.
	...
	def __init__(self, raw:str or None):
		# new tags (ordered)
		self._msg_param_profileImageURL:Optional[str] = None
		self._msg_param_viewerCount:Optional[int] = None
